...
import com.thinksync.security.security.AccessDeniedExceptionHandler;
import com.thinksync.security.security.BasicAuthEntryPoint;
...
public class ThinkSyncSecurityDevConfiguration {
  ...
  SecurityFilterChain defaultSecurityFilterChain(HttpSecurity httpSecurity) throws Exception {
    httpSecurity
        .cors(corsConfig->corsConfig.configurationSource(new CorsConfigurationSource() {    // Allow cross origin request (CORS)
          @Override
